...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Promote Students', href: '/students/promotions' },
    ],
  },
  {
    name: 'Fee Management',
  ...
  },
  {
  ...
  },
	{
		...
		children: [
			...
			{ name: 'SMS History', href: '/notifications?tab=history' },
			{ name: 'Email Templates', href: '/notifications?tab=templates' }, // Future feature
		],
	},
  {
    name: 'Settings',
